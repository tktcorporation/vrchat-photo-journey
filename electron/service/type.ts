...
const photoFileNameRegex = /^VRChat_\d{4}-\d{2}-\d{2}_\d{2}-\d{2}-\d{2}.\d{3}_\d{3,4}x\d{3,4}$/;
const PhotoFileNameSchema = z.string().regex(photoFileNameRegex);
type PhotoFileName = z.infer<typeof PhotoFileNameSchema>;
const photoFileNameWithExtRegex = /^VRChat_\d{4}-\d{2}-\d{2}_\d{2}-\d{2}-\d{2}.\d{3}_\d{3,4}x\d{3,4}\.\w+$/;
...
const parsePhotoFileName = (photoFileName: PhotoFileName | PhotoFileNameWithExt) => {
...
const JoinInfoFileNameSchema = z
  .string()
  .regex(/^VRChat_\d{4}-\d{2}-\d{2}_\d{2}-\d{2}-\d{2}.\d{3}_wrld_\w{8}-\w{4}-\w{4}-\w{4}-\w{12}$/);
