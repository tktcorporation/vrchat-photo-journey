...
function Setting() {
    ...
    const setByDialogMutation =
        trpcReact.setVRChatPhotoDirByDialog.useMutation();
        ...
        <div className="flex-auto">
            <div className="flex flex-col justify-center items-center h-full">
                ...
                <Button
                    variant="secondary"
                    onClick={() => {
                        deleteStoredPathMutation
                            .mutateAsync("vrchatPhotoDir")
                            .then(() => {
                                refetch();
                            });
                    }}
