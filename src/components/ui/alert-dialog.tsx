...
const AlertDialogTitle = React.forwardRef<React.ElementRef<typeof AlertDialogPrimitive.Title>, AlertDialogTitleProps>(
  ({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Title {...props} ref={ref} className={cn('text-lg font-semibold', className)} />
  )
);
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description {...props} ref={ref} className={cn('text-sm text-muted-foreground', className)} />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action {...props} ref={ref} className={cn(buttonVariants(), className)} />
));
