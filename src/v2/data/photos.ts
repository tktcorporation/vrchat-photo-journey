...
const locations = [
  {
    ...
    prefecture: '東京都',
    country: '日本',
    description: '東京都台東区浅草にある聖観音宗の仏教寺院。都内最古の寺院で、雷門と仲見世通りで知られる観光名所。',
  ...
  },
  {
    ...
    prefecture: '山梨県',
    country: '日本',
    description: '日本最高峰の山。世界文化遺産に登録された日本の象徴的な名所。四季折々の美しい景色を楽しめる。',
  ...
  },
  {
    ...
    prefecture: '京都府',
    country: '日本',
    description: '京都を代表する寺院。舞台造りの本堂と美しい庭園で知られ、桜や紅葉の名所としても人気。',
  ...
  },
  {
    ...
    prefecture: '広島県',
    country: '日本',
    description: '世界遺産の厳島神社がある島。海に浮かぶ大鳥居と美しい自然景観で知られる。',
...
export const generatePhotos = (): Photo[] => {
  ...
  for (let i = 0; i < 200; i++) {
    ...
    photos.push({
      ...
      tags: [category.season, ...category.items, `${imageVariant.width}x${imageVariant.height}`],
      takenAt: photoDate,
      location: {
        ...location,
